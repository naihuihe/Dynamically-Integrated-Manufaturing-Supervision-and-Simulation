...
class SurfaceCanvas_M(tk.Canvas):
    ...
    def __init_coordinate_system(self):
        ...
        h_x1, h_x2 = self.__coord_x - 50, self.__coord_x + self.Configs['layout_length'] + 50
        h_y1 = h_y2 = self.__coord_y

        v_x1 = v_x2 = self.__coord_x
        v_y1, v_y2 = self.Configs['layout_width'] + self.__coord_y + 50, self.__coord_y - 50
    ...
    def __add_grid_lines(self):
        ...
        def plot_lines(horizontal = True):
            ...
            while nextline < stopline:
                ...
                self.create_line(bbox, tags = self.Grid, fill="#e2e3e0", state = 'disabled')
                nextline += grid_interval
    ...
    def origin_coordinate(self):
        """
        :return: a tuple ==> the origin of coordinate system
        """
